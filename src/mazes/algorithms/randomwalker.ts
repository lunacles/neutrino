...
const defaultWalkerInstructions: WalkerInstructions = {
  startDirections: [...Maze.movementOptions.horizontal as Array<number>, ...Maze.movementOptions.vertical as Array<number>],
  branchDirections: [...Maze.movementOptions.horizontal as Array<number>, ...Maze.movementOptions.vertical as Array<number>],
  placementType: 1,
}
